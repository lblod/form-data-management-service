...
const CONCEPT_SCHEMES = [
  ...
  "http://lblod.data.gift/concept-schemes/f7274d7f-31d5-4b02-aca8-b96481115651", // Subsidy application statuses
...
export async function constructMetaData() {
  ...
  fs.writeFile(META_FILE_PATH, content, 'utf8');
}
...
WHERE {
    GRAPH ?g {
        ?unit skos:inScheme ${sparqlEscapeUri(ADMINISTRATIVE_UNITES)} ;
